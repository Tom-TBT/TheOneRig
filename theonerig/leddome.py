# AUTOGENERATED! DO NOT EDIT! File to edit: ../13_leddome.ipynb.

# %% auto 0
__all__ = ['get_dome_positions', 'as_cartesian', 'as_spherical', 'angular_distance', 'build_wave_stimulus_array', 'Quaternion',
