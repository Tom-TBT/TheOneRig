# AUTOGENERATED! DO NOT EDIT! File to edit: ../03_modelling.ipynb.

# %% auto 0
__all__ = ['sigmoid', 'gaussian', 'sum_of_gaussian', 'diff_of_gaussian', 'gaussian_2D', 'sum_of_2D_gaussian', 'exponential_decay',
           'sin_exponent', 'sinexp_sigm', 'fit_sigmoid', 'fit_spatial_sta', 'fit_temporal_sta', 'fit_chirp_am',
           'fit_chirp_freq_epoch', 'fit_transiency', 'repetition_quality_index', 'onoff_transient_index']

# %% ../03_modelling.ipynb 4
import math
import scipy as sp
