# AUTOGENERATED! DO NOT EDIT! File to edit: ../06_eyetrack.ipynb.

# %% auto 0
__all__ = ['interpolate_screen_pos', 'interpolate_checker_pos', 'split_eye_events', 'get_spherical_map', 'apply_spherical_map']
